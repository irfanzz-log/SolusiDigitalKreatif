...
export default function page() {
    return (
        <main className="relative min-h-screen">
            ...
            <div className="">
                <section
                    className="w-full flex flex-col bg-gradient-to-b from-blue-400/70 via-yellow-700/20 to-white">
                    <div className="p-5">
                        <motion.div
                        ...
                        <div className="w-full">
                            ...
                            <div className="w-full flex md:flex-row flex-col justify-center items-center">
                                <motion.div
                                    ...
                                    viewport={{ once: true }}
                                    transition={{ duration: 1 }}
                                    className="relative md:w-1/3 w-full flex flex-col rounded-xl overflow-hidden bg-white shadow-md m-5">
                                    ...
                                    <div className="p-5 m-2">
                                        ...
                                        <a target="_blank" rel="noopener noreferrer" href="https://api.whatsapp.com/send/?phone=085788513910&text=Hallo%20saya%20mau%20buat%20website%20undangan%20digital%20tema%20jawa&type=phone_number&app_absent=0" className="mt-4 mx-3 p-2 px-3 text-xs text-red-600 rounded-full border-[1px] border-red-600">Buat Penawaran</a>
                                        </div>
                                    </div>
                                </motion.div>
                                <motion.div
                                    ...
                                    <div className="p-5 m-2">
                                        ...
                                        <p className="text-lg font-bold mt-5">Harga : <span className="bg-gradient-to-r from-red-500 to-yellow-400 bg-clip-text text-transparent text-2xl">Rp96.000</span> <span className="line-through text-xs">Rp170.000</span></p>
                                        <div className="w-full flex items-center">
                                            <button onClick={() => {
                                            window.open(
                                        ...
                                        <a target="_blank" rel="noopener noreferrer" href="https://api.whatsapp.com/send/?phone=085788513910&text=Hallo%20saya%20mau%20buat%20website%20undangan%20digital%20tema%20light&type=phone_number&app_absent=0" className="mt-4 mx-3 p-2 px-3 text-xs text-red-600 rounded-full border-[1px] border-red-600">Buat Penawaran</a>
                                        </div>
                                    </div>
                                </motion.div>
                            </div>
